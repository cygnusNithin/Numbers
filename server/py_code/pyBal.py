...
MAX_COUNT = 12    # 🎯 Cap for "remaining_to_12"
...
for num in tqdm(unique_numbers, total=len(unique_numbers), desc="Processing numbers"):
    ...
    patterns.append({
        ...
        "remaining_to_12": max(0, MAX_COUNT - total_hits),
...
out_df.to_csv("5000_number_patterns6.csv", index=False, encoding="utf-8")

print("✅ Saved detailed number patterns to 5000_number_patterns6.csv")
