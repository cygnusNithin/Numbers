...
SORT_DESC = True      # ✅ Sort by hit count descending
...
# 🔢 Sort first by number (ascending) and then by total_hits (desc/asc)
out_df = out_df.sort_values(
    by=["number", "total_hits"],
    ascending=[True, not SORT_DESC]
)

out_df.to_csv("5000_number_patterns10.csv", index=False, encoding="utf-8")

print("✅ Saved detailed number patterns to 5000_number_patterns10.csv")
