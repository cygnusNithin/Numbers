...
# dayfirst=True lets dd/mm and dd.mm parse correctly; ISO also works.
...
time_summary = (
    df_valid.groupby("number", group_keys=False)
...
out_df.to_csv("all_prizes_number_patterns19.csv", index=False, encoding="utf-8")
print("✅ Saved detailed number patterns to all_prizes_number_patterns19.csv")