...
# 💾 Save to CSV
out_df.to_csv("5000_number_patterns31.csv", index=False, encoding="utf-8")

print("✅ Saved detailed number patterns with serial number to 5000_number_patterns31.csv")
